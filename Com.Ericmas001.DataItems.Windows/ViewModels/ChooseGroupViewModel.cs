...
using Com.Ericmas001.DataItems.Windows.Filters;
using Com.Ericmas001.Windows;
using GalaSoft.MvvmLight.CommandWpf;

namespace Com.Ericmas001.DataItems.Windows.ViewModels
{
    public class ChooseGroupViewModel : BaseViewModel
    {
        ...
        public void AddFieldToFilter(string field, BaseFilterInCreation[] filters)
        {
            ...
            RaisePropertyChanged(nameof(AllFields));
        ...
        public string CurrentField
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(AvailablesFilters));
            }
        }

        public BaseFilterInCreation[] AvailablesFilters => m_AvailablesFilters;
        ...
        {
            get { return m_ChooseCritereCommand ?? (m_ChooseCritereCommand = new RelayCommand(OnCritereChoosen, CanChooseCritere)); }
        }

        public ICommand RemoveCritereCommand
        {
            get { return m_RemoveCritereCommand ?? (m_RemoveCritereCommand = new RelayCommand(OnCritereRemoved, CanRemoveCritere)); }
        }

        public ICommand MoveUpCritereCommand
        {
            get { return m_MoveUpCritereCommand ?? (m_MoveUpCritereCommand = new RelayCommand(OnCritereMovedUp, CanMoveUpCritere)); }
        }

        public ICommand MoveDownCritereCommand
        {
            get { return m_MoveDownCritereCommand ?? (m_MoveDownCritereCommand = new RelayCommand(OnCritereMovedDown, CanMoveDownCritere)); }
        }
